...
# Load the 3D model
bbox3d_model = tf.keras.models.load_model('mobilenetv2\mobilenetv2_weights.h5',custom_objects={'orientation_loss':orientation_loss})
...
# Load a 2D model
bbox2d_model = YOLO('model_v8.pt')  # load an official model
